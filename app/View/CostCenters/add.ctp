<h3><?php echo $this->html->link('Centro de costos','/cost_centers/'); ?> &gt; Agregar centro de costos</h3>
<?php echo $this->Session->flash();  ?>


<div id="TitleView">
	<h2 class="link_admin link_add">Agregar Centro de Costos</h2>
	<ul>
...
<table>
	<tr>
		<td class="border_none">
			...
			echo $this->form->input('cost_center_code', array('label' => 'Codigo del centro de costo'));
