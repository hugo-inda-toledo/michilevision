...
<div class="paging_results">
	<?php echo $this->paginator->counter(array('format' => 'Pagina %page% de %pages% (Mostrando %current% centros de costo de un total de %count% centros de costo).'));?>
</div>
    ...
    <tr>
		...
		<td>
			<?php echo  $this->Html->link('Eliminar', 
				...
				array('title' => 'Eliminar centro de costo '.$cost_center['CostCenter']['cost_center_name'], 'class' => 'tip_tip_default link_admin link_delete'),
