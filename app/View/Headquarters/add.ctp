<h3><?php echo $this->html->link('Gerencias','/managements/'); ?> &gt; <?php echo $this->html->link('Jefaturas','/headquarters/'); ?> &gt; Agregar jefatura</h3>
<?php echo $this->Session->flash();  ?>


<div id="TitleView">
	<h2 class="link_admin link_add">Agregar Nueva Jefatura</h2>
	<ul>
...
<table>
	<tr>
		<td class="border_none">
			...
			echo $this->form->input('user_id', array('label' => 'Jefe asociado','type' => 'select','options' => $selectUsuarios,'div' => array('class'=>'select'), 'empty' => ''));
			echo '</td>
				<td>';
			...
			echo '<br /><br />
				<input type="submit" value="Guardar Jefatura"></input></td>
				</tr>
				</table>
			</form>';
