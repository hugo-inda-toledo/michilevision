...
$tcpdf->SetTitle("Cuantificador de gastos para usuarios desde el ".$data['Details']['start_date']." hasta ".$data['Details']['end_date']);
...
$tcpdf->Cell(10,30,'Cuantificador de gastos (Usuarios)', 0, 0);
...
$html .= "<br><br>Usuario asociado al informe: <font color=\"#800E0E\">".$data['Details']['user'].'</font><br>';
...
echo $tcpdf->Output('user_report_from_'.$data['Details']['start_date'].'_to_'.$data['Details']['end_date'].'.pdf', 'D');
