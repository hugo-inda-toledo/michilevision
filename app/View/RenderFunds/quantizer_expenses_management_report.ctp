...
$tcpdf->SetTitle("Cuantificador de gastos para centro de costo y/o gerencia desde el ".$data['Details']['start_date']." hasta ".$data['Details']['end_date']);
...
$html .= "<br><br>Gerencia asociada al informe: <font color=\"#800E0E\">".$data['Details']['management_name'].'</font><br>';
$html .= "Centro de costo asociado al informe: <font color=\"#800E0E\">".$data['Details']['cost_center_name']."</font><br>";
...
echo $tcpdf->Output('management_report_from_'.$data['Details']['start_date'].'_to_'.$data['Details']['end_date'].'.pdf', 'D');
