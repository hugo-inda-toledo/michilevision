<h3><?php echo $this->html->link('Secciones de sistemas','/system_sections/'); ?> &gt; Editando la sección</h3>
<?php echo $this->Session->flash();  ?>


<div id="TitleView">
	<h2 class="link_admin link_add">Editar Sección a un sistema</h2>
	<ul>
	...
	<tr>
		<td class="border_none">
			...
			<table>
				...
				<tr>
					<td><?php echo $this->form->end('Editar Seccion'); ?></td>
				</tr>
			</table>
		</td>	
	</tr>
