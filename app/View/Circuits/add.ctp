<h3><?php echo $this->html->link('Circuitos','/circuits/'); ?> &gt; Crear nuevo circuito<h3>
<?php echo $this->Session->flash();  ?>


<div id="TitleView">
	<h2 class="link_admin link_add">Crear Nuevo Circuito</h2>
	<ul>
...
<table>
	<tr>
		<td class="border_none">
			...
			echo $this->form->input('authorization_id', array('label' =>'Tipo de autorizacion', 'type' =>'select', 'options' => $authorizations));
