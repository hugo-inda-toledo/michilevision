<h3><?php echo $this->html->link('Permisos','/permissions/'); ?> &gt; Agregar permiso</h3>
<?php echo $this->Session->flash();  ?>


<div id="TitleView">
	<h2 class="link_admin link_add">Agregar Nuevo Permiso</h2>
	<ul>
...
<table>
	<tr>
		<td class="border_none">
			...
			echo $this->form->input('system_id', array('label' => 'Sistema Asociado', 'type' => 'select', 'empty' => '','options' => $sistemas));
